...
module.exports = function (dbName, callback) {        	                        //El callback como argumento se ejecutara cuado la conexion este establecida
...
module.exports('MEANapp', (connection) => process.env.MAIN_DB = connection);                //Iniciamos la conexion con la base de datos principal
/******************************************************************************************************/
